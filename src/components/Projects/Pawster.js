import pGif from "../../imgs/pawsterGif.gif"
...
export default function Pawster() {
    return (
        <div className="flex justify-center animate__animated animate__fadeIn">
            <div className="flex flex-col w-full 2xl:flex-row 2xl:w-11/12 justify-evenly p-4 rounded-md border-gray-400">
                <div className="flex w-full p-9 justify-center">
                    <img src={pGif} className="rounded" alt="Pawster Gif"/>
                </div>
                <div className="flex-col text-white text-lg p-4 font-light w-full 2xl:w-5/6">
                    <h1 className="font-medium text-2xl mt-4 mb-4">Pawster - Crowd Sourced Pet Kenneling Services</h1>
                    <h2 className="mt-3 font-medium text-yellow-200">ABOUT</h2>
                    <p>
                        Pawster was developed by a team of three over the course of two weeks.
                        The front-end was built in Javascript focusing on React and Redux libraries.The back-end
                        was built using Apollo-server and Node.js, utilizing GraphQL for the API endpoints connected to a 
                        MongoDB database via mongoose ODM. The CSS was built around TailwindCSS utilizing HeadlessUI's
                        library. 
                    </p>
                    <div className="flex mt-10 justify-evenly font-medium text-yellow-200">
                        <a href="https://pawster.herokuapp.com/" target="__blank" className="transition ease-in-out hover:scale-110 flex border w-2/5 sm:w-1/5 justify-center rounded border-yellow-200">Live Link</a>
                        <a href="https://github.com/technotobes/Pawster" target="__blank" className="transition ease-in-out hover:scale-110 flex border w-2/5 sm:w-1/5 justify-center rounded border-yellow-200" >GitHub</a>
                    </div>
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="flex-col text-slate-400 p-4 hover:text-yellow-200">
                            <div className="flex justify-center"><SiGraphql size="2em"/></div>
                            <p className="flex justify-center text-sm mt-2">GraphQL</p>
                        </div>
                        <div className="flex-col text-slate-400 p-4 hover:text-yellow-200">
                            <div className="flex justify-center"><SiMongodb size="2em"/></div>
                            <p className="flex justify-center text-sm mt-2">MongoDB</p>
                        </div>
                        <div className="flex-col text-slate-400 p-4 hover:text-yellow-200">
                            <div className="flex justify-center"><SiTailwindcss size="2em"/></div>
                            <p className="flex justify-center text-sm mt-2">TailwindCSS</p>
                        </div>
                        <div className="flex-col text-slate-400 p-4 hover:text-yellow-200">
